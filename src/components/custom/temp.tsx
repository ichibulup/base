    ...
    >
      ...
      >
        <div
          ...
          // className="group-data-[variant=floating]:border-sidebar-border h-full w-full group-data-[variant=floating]:border"
...
const sidebarMenuButtonVariantsz = cva(
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        "flex min-w-0 translate-x-px flex-col gap-1 pt-1",
